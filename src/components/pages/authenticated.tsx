...
export const Authenticated: FC<AuthenticatedProps> = () => {
  ...
  return (
    <>
      ...
      <BodyText>
        Your Reapit connectSession object is available via the useReapitConnect
        hook and will be automatically refreshed unless you logout. This will
      ...
      <BodyText>
        There is a sample fetch service that pulls Appointment Config Types from
        Foundations API to demonstrate fetching data using this scaffold,
        logging the data out to the JS console. Naturally you can replace this
      ...
      <BodyText>
        Included in the scaffold is the latest version of the Elements UI
